...
class FunctionRegistry:
    ...
    def to_records(self) -> list[dict]:
        """Convert registry to a list of records suitable for DataFrame conversion."""
        records = []
        for category, functions in self._registry.items():
            category_desc = self._categories[category]
